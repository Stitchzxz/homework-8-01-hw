# Домашнее задание к занятию "`Обзор систем IT-мониторинга`" - `Николай Концевой`
...
![Скрин dashboard](https://github.com/Stitchzxz/homework_netology/blob/main/screen/Dashboard.jpg)
